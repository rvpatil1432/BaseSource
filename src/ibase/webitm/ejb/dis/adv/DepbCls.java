...
public class DepbCls extends ActionHandlerEJB implements DepbClsLocal, DepbClsRemote
{
	...
	public String actionHandler(String tranID, String xtraParams, String forcedFlag) throws RemoteException,ITMException
	{
		...
		{
			System.out.println("Exception :DepbCls :actionHandler :" + e.getMessage() + ":");
			e.printStackTrace();
			throw new ITMException(e);
		}
		System.out.println("returning String from DepbCls :actionHandler :"+retString);
		return retString;
	}
	...
	private String actionClose(String tranID, String xtraParams, String forcedFlag) throws RemoteException,ITMException
	{
		...
		{
			System.out.println("The sqlException occure in DepbCls :"+sqx);
			throw new ITMException(sqx);
		}
		catch (Exception e)
		{
			System.out.println("The Exception occure in DepbCls :"+e);
			throw new ITMException(e);
		}
		finally
		{
