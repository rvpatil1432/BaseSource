	...
	public String confirm( String tranId, String xtraParams, String forcedFlag, Connection conn, boolean connStatus ) throws RemoteException,ITMException
	{
		...
		try
		{
			...
			if(count > 0 )
			{
				...
				retString = itmDBAccess.getErrorString("","VTNTCNF1","","",conn);
				return retString;
			}*/
			...
			{	System.out.println("Travel information Cancelled");
				retString = itmDBAccess.getErrorString("","VTNOTCONF3","","",conn);
				return retString;
			}else if("O".equalsIgnoreCase(status))
			{	System.out.println("Travel information not submitted");
					retString = itmDBAccess.getErrorString("","VTNOTSUB2","","",conn);
					return retString;
			}
			else
			{
		...
		finally
		{
			if(retString != null && retString.indexOf("confirmed") > -1)
			{
				...
				retString = itmDBAccess.getErrorString("","VCNFSUC1","","",conn);
			}
			...
			{
				retString = itmDBAccess.getErrorString("","VTERRCON","","",conn);
			}
			try{
	...
	public String travel( String tranId, String xtraParams, String forcedFlag ) throws RemoteException,ITMException
	{
		...
		try
		{
			...
			{	System.out.println("Travel information not Traveled");
					retString = itmDBAccess.getErrorString("","VTTRVFAIL","","",conn);
					return retString;
			}
			else
			{
				...
				if(count > 0 )
				{
					...
					if(travelCount > 0 )
					{
						...
						retString = itmDBAccess.getErrorString("","VTTRAVEL","","",conn);
						return retString;
					}
					else
					{
		...
		finally
		{
			if(retString != null && retString.indexOf("traveled") > -1)
			{
				...
				retString = itmDBAccess.getErrorString("","VTTRVSUC","","",conn);
			}
	...
	public String notTravel( String tranId, String xtraParams, String forcedFlag ) throws RemoteException,ITMException
	{
		...
		try
		{
			...
			{	System.out.println("Travel information is  Traveled");
				retString = itmDBAccess.getErrorString("","VTNOTTRFA","","",conn);
				return retString;
			}
			else
			{
				...
				if(count > 0 )
				{
					...
					if(travelCount > 0 )
					{
						...
						retString = itmDBAccess.getErrorString("","VTNOTTRA","","",conn);
						return retString;
					}
					else
					{
		...
		finally
		{
			if(retString != null && retString.indexOf("notTraveled") > -1)
			{
				...
				retString = itmDBAccess.getErrorString("","VTNOTTRSUC","","",conn);
			}
	...
	public String open( String tranId, String xtraParams, String forcedFlag ) throws RemoteException,ITMException
	{
			...
			}else
			{
				...
				if(count > 0 )
				{
					...
					if(travelCount > 0 )
					{
						...
						retString = itmDBAccess.getErrorString("","VTOPENAL","","",conn);
						return retString;
					}
					...
					}else if("S".equalsIgnoreCase(status))
					{
						...
						retString = itmDBAccess.getErrorString("","VTETNOTOP","","",conn);
						return retString;
					}
				}else
				{
		...
		finally
		{
			if(retString != null && retString.indexOf("open") > -1)
			{
				...
				retString = itmDBAccess.getErrorString("","VTOPENSUC","","",conn);
			}
