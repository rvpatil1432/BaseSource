...
public class InsuranceCls extends ActionHandlerEJB implements InsuranceClsLocal, InsuranceClsRemote
{
	...
	public String actionHandler(String tranID, String xtraParams, String forcedFlag) throws RemoteException,ITMException
	{
		...
		{
			System.out.println("Exception :InsuranceCls :actionHandler :" + e.getMessage() + ":");
			e.printStackTrace();
			throw new ITMException(e);
		}
		System.out.println("returning String from InsuranceCls :actionHandler :"+retString);
		return retString;
	}
	...
	private String actionClose(String tranID, String xtraParams, String forcedFlag) throws RemoteException,ITMException
	{
		...
		{
			System.out.println("The sqlException occure in InsuranceCls :"+sqx);
			throw new ITMException(sqx);
		}
		catch (Exception e)
		{
			System.out.println("The Exception occure in InsuranceCls :"+e);
			throw new ITMException(e);
		}
		finally
		{
