...
@javax.ejb.Stateless
public class PoReceiptVerifyPasswordIC extends ValidatorEJB implements PoReceiptVerifyPasswordICLocal, PoReceiptVerifyPasswordICRemote 
{
	...
	public String itemChanged(String xmlString, String xmlString1, String xmlString2, String objContext, String currentColumn, String editFlag, String xtraParams) throws RemoteException, ITMException
	{
		...
		E12GenericUtility genericUtility = new E12GenericUtility();
		System.out.println("-----------Calling PoReceiptVerifyPasswordIC----itemChanged(String)----------");
		...
		{
			System.out.println("Exception :PoReceiptVerifyPasswordIC :itemChanged(String):"+ e.getMessage() + ":");
			e.printStackTrace();
	...
	{	
		...
		System.out.println("-----------Calling PoReceiptVerifyPasswordIC----itemChanged(Document)----------");
		...
		try
		{
			...
			case 1:
			{
				...
				if( currentColumn.trim().equalsIgnoreCase( "itm_default" ) )
				{
					...
					sql = "select confirmed, conf_passwd from porcp where tran_id = ?";
		...
		{						
			System.out.println("Exception :PoReceiptVerifyPasswordIC :itemChanged(Document):"+ e.getMessage() + ":");
			e.printStackTrace();
			throw new ITMException(e);
		}
		finally
